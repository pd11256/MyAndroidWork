        ...
        switch (id){
            case DIALOG_TEXT:
                AlertDialog.Builder builder1 =
                        new AlertDialog.Builder(this); //  생성자 : context:this 는 제어권자, 자기가하고싶은것(여기는 옛날버전만간으)
            ...
            case DIALOG_LIST:
                ...
                builder2.setTitle("리스트 형식 다이얼로그 제목")
                        ...
                        .setItems(str, new DialogInterface.OnClickListener() {
                            ...
                            //which : 몇번째 선택되었는지 에 대한 값  ( 자동으로 오버라이딩 되는 것임) !!
            ...
            case DIALOG_MULTICHOICE:
                ...
                builder4.setTitle("MultiChoice 다이얼로그 제목")
                        .setPositiveButton("선택완료", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                String str ="선택된 값은 : ";
                                //TODO 밑에 멀티 초이스의 checked[which] = isChecked; 이부분을 한것임
                        ...
                        .setNegativeButton("취소",null)
                        .setMultiChoiceItems(data, //라디오와 다르게 멀티초이스 아이템! ,체크박스 리스트 항목 배열
                                checked, //초깃값 (선택여부) 배열
                                //체크박스 선택했을때 호출되는 콜백
