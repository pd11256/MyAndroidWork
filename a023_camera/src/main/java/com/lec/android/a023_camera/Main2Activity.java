...
public class Main2Activity extends AppCompatActivity {
            ...
            public void onPictureTaken(byte[] data, Camera camera) {
                ...
                if(outUristr ==null){
                    ...
                    sendBroadcast(new Intent(
                            Intent.ACTION_MEDIA_SCANNER_SCAN_FILE,outUri)); //이러한 이벤트가 발생되었다고 알려주는것
                }

                camera.startPreview(); //촬영후 프리뷰 다시제거
            }
        });
    ...
    private class CameraSurfaceView extends SurfaceView implements SurfaceHolder.Callback{
        ...
        private Camera camera =null; //맨위에보면 하드웨어 카메라로 import 했음


        //생성자에선 SurfaceHolders 객체 참조후 설정
        ...
        //SurfaceView 가 만들어질떄, 카메라 객체를 참조한 후 미리보기 화면으로
        //홀더 객체 설정
        @Override
