...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Drawable drawable = getResources().getDrawable(R.drawable.a3); //deprecated 됨. 앞으로 사라질수도잇다는뜻
        Drawable drawable = ContextCompat.getDrawable(getApplicationContext(), R.drawable.a3);
                                        // *ContextCompat : API123부터 추가
                                        // Context() 현재실행되고있는객체가 온다 (activity_main이들어온다) 자주보게될표현
