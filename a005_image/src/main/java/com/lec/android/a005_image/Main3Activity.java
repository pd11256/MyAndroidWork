 ...
 * 사용자에게 권한 허락받는 코드를 작성해야한다(개인정보이기때문에 권한 을 요청해서 받아야한다)
 *    1. 권한 획득
 *        - 메니페스트
...
public class Main3Activity extends AppCompatActivity {
    ...
    private String imgPath ="/sdcard/DCIM/Camera/IMG_20200416_083205.jpg";

    private final int PERMISSION_REQUEST_CODE = 101; //권한 요청 코드값(int)
    private final String [] PERMISSIONS = {//요청할 권한들을 String[]로준비
    ...
    //'위험권한'    획득!!!
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M &&
            ...
            //내부 스토리지에대한 권한이있는지 Check, 승인받지않았을때 권한요청!
