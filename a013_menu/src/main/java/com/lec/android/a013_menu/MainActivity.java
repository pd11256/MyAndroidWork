...
// 메뉴버튼을 눌렀을 때 보여줄 menu 에 대해서 정의
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_main1, menu);//xml로부터 메뉴화면을 만드는것
        Log.d("myapp","onCreateOptionMenu -최초 메뉴키를 눌렀을때 호출됨");
        ...
        MenuItem item3 = menu.add(1,MENUITEM_CYAN,100,"씨안");
        //로그인 ,로그아웃,다음은 지정해준값이없기떄문에 0,0,0 이출력됨
...
// '옵션메뉴'가 화면에 보여질때마다 호출되는 메소드
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        Log.d("myapp","onPrepareOptionsmMenu -옵션메뉴가 화면에 보여질때 마다  호출됨");
        //메뉴가 보여질때마다 '로그인', '로그아웃'이 enable/disable토글되어 보이기
    ...
    public void showInfo(MenuItem item){
        ...
        int groupid =item.getGroupId(); //옵션 메뉴 아이템의 그룹id값 (정수)
