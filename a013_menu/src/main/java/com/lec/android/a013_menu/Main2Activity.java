        ...
        switch (v.getId()){
            case R.id.tvCtxMenu:
                ...
                menu.setHeaderTitle("색상을 선택하세요")
                   //     .setHeaderIcon(R.drawable.face16)
                     ;
                menu.add(0,1,100,"빨강");
                menu.add(0,2,100,"녹색");
                menu.add(0,3,100,"파랑");
            ...
            case R.id.ivCtxView:
                menu.setHeaderTitle("메뉴를 선택하세요");
                menu.add(1,1,100,"아이언맨");
                menu.add(1,2,100,"캡");
                menu.add(1,3,100,"싸이신");
                //그룹아이디를 분류함
             ...
             case 1:
                        switch (id){
                            case 1 :
                                ...
                                return true;
                                case 2 :
                                ivCtxMenu.setImageResource(R.drawable.face19);
                                return true;
                                case 3 :
                                ivCtxMenu.setImageResource(R.drawable.face21);
                                return true;
